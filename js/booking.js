...
// Updated fallback values to match your new defaults cleanly
const selectedService = localStorage.getItem("selectedService") || "Hairdresser";
const selectedImage = localStorage.getItem("selectedImage") || DEFAULT_BLANK_SVG;
